    ...
    <div className="border py-8 sm:px-8">
      ...
      <div className="container mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-light text-black mb-4 tracking-widest font-serif">
            LuxWatch Inc
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8 px-8">
          <div className="lg:w-1/3 h-full">
            <div className="bg-gray-200 p-10 rounded-md border border-black relative">
              <h2 className="text-2xl font-light text-black mb-10 uppercase tracking-widest">
                ABOUT US
              </h2>
              <div className="mb-10">
              ...
              <div className="mb-10">
                ...
                <p className="text-black pl-12 tracking-wide">
          ...
          <div className="lg:w-2/3 h-full">
            <div className="bg-gray-200 p-10 border rounded-md border-black relative">
              <h2 className="text-2xl font-light text-black mb-4 uppercase tracking-widest">
                CONTACT
              </h2>
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-light text-black mb-2 uppercase tracking-widest"
                    >
                    ...
                    <Input
                      ...
                      } focus:outline-none rounded-md bg-white h-12 text-black placeholder-gray-600`}
                    />
                    {errors.name && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 bg-white border-b-2 focus:outline-none appearance-none rounded-md ${
                ...
                <div className="mb-10">
                  ...
                  <Textarea
                    ...
                    } focus:outline-none rounded-md bg-white text-black placeholder-gray-600`}
                  />
                  {errors.message && (
                    <p className="mt-2 text-sm text-red-500">
                      {errors.message}
