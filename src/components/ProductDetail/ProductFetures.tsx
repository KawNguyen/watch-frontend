...
const features = [
    {
        ...
        description: "Swiss-made automatic movement with 28,800 vibrations per hour for exceptional accuracy."
    },
    {
        icon: ShieldIcon,
        title: "Premium Materials",
        description: "Crafted from surgical-grade stainless steel and scratch-resistant sapphire crystal."
    },
    {
        icon: AwardIcon,
        title: "Master Craftsmanship",
        description: "Hand-finished by master watchmakers with decades of experience in fine horology."
    },
    {
        icon: RefreshCwIcon,
        title: "Lasting Heritage",
        description: "Built to be passed down through generations with proper care and regular servicing."
    }
                ...
                <div className="mt-12 text-center">
                    <div className="flex justify-around items-center border-t border-b border-gray-200 py-5 px-4">
                        {specifications.map((spec, index) => (
                            <div key={index} className={`text-left ${index !== specifications.length - 1 ? 'mr-8' : ''}`}>
                                <p className="text-sm font-medium text-gray-900">{spec.label}</p>
